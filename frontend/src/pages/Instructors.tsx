  ...
  return (
    <main>
      ...
      <section className="padding-x padding-y flex flex-col gap-16">
        <InstructorCarousel data={instructors} title="popular instructors" />
        <InstructorCarousel data={instructors} title="top star instructors" />
      ...
      <Jumbotron
        ...
        button={
          <Button variant={"primary"} asChild>
            <NavLink to="/auth/instructor-application">Become a Part</NavLink>
          </Button>
        }
      />
      <section className="padding-x padding-y flex flex-col gap-16">
