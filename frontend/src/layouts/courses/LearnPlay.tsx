...
import AutoSubtitleGenerator from "@/components/AutoGenerateSubtitle";
...
const LearnPlay = () => {
  ...
  const [autoGeneratedSubtitles, setAutoGeneratedSubtitles] = useState<
    string | null
  >(null);
  ...
  const handleAutoSubtitlesGenerated = (subtitlesUrl: string) => {
    console.log(autoGeneratedSubtitles);
    setAutoGeneratedSubtitles(subtitlesUrl);
  };
    ...
    <main className="flex flex-col w-full ">
      ...
      <div className="mt-4">
        {/* <AutoSubtitleGenerator
          ...
          onSubtitlesGenerated={handleAutoSubtitlesGenerated}
        /> */}
