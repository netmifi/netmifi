        ...
        <div className="flex flex-col px-4 sm:px-8 md:px-28">
          ...
          <div className="flex justify-between gap-5">
            ...
            <div className="flex gap-2">
              ...
              <Button variant={'transparent'} className="p-0"><FaFlag size={20} /></Button>
            </div>
          ...
          <div className="flex flex-col gap-8 mt-28">
            ...
            <div className='flex flex-col gap-5'>
              ...
              <div className="flex flex-col">
                <h2 className="text-xl"> {blog.comments.comments?.length} Comment{blog.comments.comments?.length !== 1 && 's'}</h2>
